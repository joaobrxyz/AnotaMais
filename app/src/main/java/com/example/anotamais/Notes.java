...
public class Notes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btGerarComIa.setOnClickListener(v -> {
            ...
            String promptPergunta = "Estou te utilizando como api em um projeto, então quero que vc apenas retorne oq eu pedir, sem vc falar nada. Estou gerando um flashcard, onde tem uma pergunta curta e uma resposta curta, nesse prompt quero que vc retorne apenas uma pergunta sobre essa aula: " + textoConteudo;
                ...
                public void onResponse(String questionResponse) {
                    runOnUiThread(() -> {
                        ...
                        if (questionResponse.startsWith("{") || questionResponse.contains("error")) {
                            ...
                            String promptResposta = "Estou te utilizando como api em um projeto, então quero que vc apenas retorne oq eu pedir, sem vc falar nada. Estou gerando um flashcard, onde tem uma pergunta curta e uma resposta curta, nesse prompt quero que vc retorne apenas a resposta sobre essa pergunta: " + questionResponse;
